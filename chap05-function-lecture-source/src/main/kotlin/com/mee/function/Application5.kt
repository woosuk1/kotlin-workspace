 ...
 *
 * 람다식의 구성
 * val 함수처럼 사용 할 변수람다식의 선언 자료형 -> 람다식의 변환 자료형 {람다식의 매개변수 -> 람다식의 처리 내용}
 *
 * 1. 전체 모습
...
//    val square: (Int) -> Int = { number: Int -> number * number }
    ...
    /* 매개변수 없고 반환형도 없는 람다식 (void 대신 unit으로 씀) */
//    var printHello: () -> Unit = { println("Hello") }
    var printHello = { println("Hello") }
    printHello()

    /* it을 활용한 축약형(매개변수가 하나일 때 주로 사용) */
//    var sayHelloTo: (String) -> Unit = {name: String -> println("say hello to $name")}
